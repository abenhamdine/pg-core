...
module.exports = function(Client) {
  var pools = {
    ...
    getOrCreate: function(clientConfig) {
      ...
      var timeout;
      if (typeof defaults.connectTimeout === "number" && !isNaN(defaults.connectTimeout)) {
        timeout = defaults.connectTimeout;
      } else if (typeof clientConfig.connectTimeout === "number" && !isNaN(clientConfig.connectTimeout)) {
